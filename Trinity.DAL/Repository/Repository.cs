...
namespace Trinity.DAL.Repository
{
        ...
        where T : class
    {
        ...
        public LocalRepository(IDatabaseFactory databaseFactory)
        {
            DatabaseFactory = databaseFactory;
            dbset = DataContext.Set<T>();
        }

        public LocalRepository(SSKEntities dataContext)
        {
    ...
    public class CentralizedRepository<T> : IRepository<T>
        where T : class
    {
        private readonly IDbSet<T> dbset;
        private TrinityCentralizedDBEntities dataContext;
        public CentralizedRepository(IDatabaseFactory databaseFactory)
        {
            DatabaseFactory = databaseFactory;
            dbset = DataContext.Set<T>();
        }

        public CentralizedRepository(TrinityCentralizedDBEntities dataContext)
        {
            this.dataContext = dataContext;
            dbset = this.dataContext.Set<T>();
        }
        ...
        protected TrinityCentralizedDBEntities DataContext
        {
