...
namespace Trinity.Common.Utils
{
    public static class CommonUtils
    {
        public static System.Drawing.Bitmap CreateQRCode(string content, string AESKey)
        {
            ...
            var encryptContent = CommonUtils.EncryptString(content, AESKey);
        ...
        public static string EncryptString(string Message, string AESKey)
        {
            byte[] Results;
            System.Text.UTF8Encoding UTF8 = new System.Text.UTF8Encoding();
            MD5CryptoServiceProvider HashProvider = new MD5CryptoServiceProvider();
            byte[] TDESKey = HashProvider.ComputeHash(UTF8.GetBytes(AESKey));
        ...
        public static string DecryptString(string Message, string AESKey)
        {
            byte[] Results;
            System.Text.UTF8Encoding UTF8 = new System.Text.UTF8Encoding();
            MD5CryptoServiceProvider HashProvider = new MD5CryptoServiceProvider();
