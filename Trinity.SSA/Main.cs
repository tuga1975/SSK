...
namespace SSA
{
    public partial class Main : Form
    {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                LEDStatusLightingUtil.Instance.MUBApplicatorStatusUpdated += Instance_MUBApplicatorStatusUpdated;
        ...
        private void Instance_MUBApplicatorStatusUpdated(object sender, EnumMUBApplicatorStatus status)
        {
            LEDStatusLightingUtil.Instance.MUBApplicatorStatusUpdated -= Instance_MUBApplicatorStatusUpdated;
            ...
            else if (status == EnumMUBApplicatorStatus.Started)
            {
        ...
        private void Instance_MUBStatusUpdated(object sender, EnumMUBStatus status)
        {
            LEDStatusLightingUtil.Instance.MUBStatusUpdated -= Instance_MUBStatusUpdated;
        ...
        private void Instance_MUBReadyToRemove(object sender, EnumMUBStatus e)
        {
            LEDStatusLightingUtil.Instance.MUBStatusUpdated -= Instance_MUBReadyToRemove;
        ...
        private void Instance_MUBDoorFullyClosed(object sender, EnumMUBDoorStatus e)
        {
            LEDStatusLightingUtil.Instance.MUBDoorStatusChanged -= Instance_MUBDoorFullyClosed;
